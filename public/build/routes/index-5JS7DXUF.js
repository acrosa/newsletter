...
function Index() {
  ...
  }, "Pricing ", JSON.stringify(site)), /* @__PURE__ */ React.createElement("p", {
    className: "mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl"
  }, "Take control of your team (?)", JSON.stringify(notes)), /* @__PURE__ */ React.createElement("p", {
...
//# sourceMappingURL=/build/routes/index-5JS7DXUF.js.map

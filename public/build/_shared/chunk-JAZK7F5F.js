...
function SubscribeBox() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    type: "submit",
    className: "mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base text-white font-medium rounded-md bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 ring-offset-gray-300 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
...
//# sourceMappingURL=/build/_shared/chunk-JAZK7F5F.js.map

...
function SubscribeBox() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    type: "submit",
    className: "mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
...
//# sourceMappingURL=/build/_shared/chunk-RRRDSIBC.js.map

...
function SubscribeBox() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8"
  }, /* @__PURE__ */ React.createElement("div", {
    ...
    type: "submit",
    className: "mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md text-white bg-black-500 hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
  }, "Notify me")), /* @__PURE__ */ React.createElement("p", {
    className: "mt-3 text-sm text-indigo-200"
  }, "We care about the protection of your data. Read our", " ", /* @__PURE__ */ React.createElement("a", {
    href: "#",
...
//# sourceMappingURL=/build/_shared/chunk-GXTHLIHQ.js.map

...
function SubscribeBox() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    autoComplete: "email",
    required: true,
    className: "w-full border-white px-5 py-3 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 ring-offset-gray-300 focus:ring-white rounded-md",
...
//# sourceMappingURL=/build/_shared/chunk-JZFGPPSF.js.map
